      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "The Dominican Web3 Tracker platform has revolutionized how I interact with local blockchain projects and
              NFTs. It's the perfect gateway to our growing Web3 ecosystem."
            </p>
            <footer className="text-sm">Sofia Mendez, NFT Artist</footer>
          </blockquote>
        </div>
      </div>
